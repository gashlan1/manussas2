...
- [ ] Design system with AGLC branding (dark theme, blue/gold accents, KAFD background)
- [ ] DashboardLayout with sidebar navigation for all 22 modules
- [ ] Executive Dashboard with KPI cards, charts, and activity feed
- [ ] Case Management listing with filters, search, and PC intake form
- [ ] Task Board with Kanban view
- [ ] Fee Proposals page with 7 categories
- [ ] Team Directory page
...
- [ ] Review all uploaded README documents (README through README10)
- [ ] Review AGLC_CRM_KNOWLEDGE_TRANSFER.pdf
- [ ] Review AGLC_TASK_EXPORT.zip contents
- [ ] Push project structure and files to GitHub (gashlan1/manussas2)
- [ ] Sync features and models to Notion for tracking
- [ ] Add LLM-based audit and support agent
- [ ] Create new UI theme inspired by YouTube video design
- [ ] Fix RTL/LTR language layout (Arabic right-aligned, English left-aligned)
- [ ] Keep existing fonts but fix text direction per language
- [ ] Ensure feature compatibility across all modules
